...
const allContentPages: ContentPageDefinition[] = [
  ...
  },
  {
    ...
    "hero": {
      ...
      "actions": [],
      "eyebrow": "Kurumsal",
      "subtitle": "TARF; Hikmetle Düşünen, Bilgiyle Üreten Bir Düşünce Enstitüsü",
      "videoUrl": "",
      "highlight": "2008’den bu yana binlerce gençle üretim yolculuğu",
      "description": "<p>Toplumların sağlıklı bir gelecek inşa edebilmesi, yalnızca günü kurtaran çözümlerle değil; kökleri sağlam, ufku açık ve değer temelli bir düşünce zeminiyle mümkündür. Bu düşünceden hareketle kurulan düşünce enstitümüz; milli ve yerli değerleri merkeze alan, irfani bakış açısını bilimsel yöntemlerle buluşturan, sahaya dayalı ve uygulanabilir politikalar üretmeyi amaçlayan bir ortak akıl platformu olarak yola çıkmıştır.</p><p>Enstitümüz, akademik bilgi ile toplumsal tecrübe arasındaki mesafeyi azaltmayı; teori ile pratiği, gelenek ile geleceği aynı zeminde buluşturmayı hedefler. Çalışmalarımızda sloganik söylemlerden ziyade, gerçekçi analizlere, ölçülebilir çıktılara ve kalıcı etkiye odaklanır.</p><p>Bu çerçevede <strong>Aile</strong>, toplumun kurucu unsuru olarak ele aldığımız temel çalışma alanlarımızdan biridir. Enstitümüz, aileyi yalnızca sosyal bir yapı değil, kültürel sürekliliğin ve toplumsal huzurun taşıyıcısı olarak görür. Geçmişten gelen tecrübeleri günümüzün sosyolojik gerçekleriyle birlikte ele alarak; üniversiteler, yerel yönetimler ve sivil toplum kuruluşlarıyla çalıştaylar, sempozyumlar ve uzman söyleşileri düzenlemeyi; aile politikalarına yön verecek nitelikli raporlar üretmeyi amaçlar.</p><p>TARF Düşünce Enstitüsü bünyesinde faaliyet gösterecek *<strong>Eğitim Araştırmaları</strong>*, eğitim sistemine nitelikli, sürdürülebilir ve yerli çözümler sunmayı amaçlayan bir düşünce ve araştırma platformudur. bilimsel veriyi irfanla; akademik disiplini toplumsal sorumlulukla bir araya getiren yaklaşımıyla, sorunlara çözüm önerileri geliştirmeyi ve uzun vadeli bir eğitim vizyonunun inşasına katkı sunmayı hedefler.</p><p>Eğitim politikalarını analiz eden, sahadaki uygulamaları izleyen, öğretmen, öğrenci ve aile perspektiflerini dikkate alan araştırmalar yürütür. Akademik çalışmalar, politika raporları, çalıştaylar ve istişare toplantıları aracılığıyla, karar alıcılara ve uygulayıcılara yol gösterici içerikler üretir. Amaç; teorik bilgi ile sahadaki gerçekliği buluşturarak eğitimin niteliğini artırmaya katkı sağlamaktır.</p><p><strong>Gençlik</strong> alanındaki çalışmalarımız, geleceği inşa edecek insan kaynağının niteliğini güçlendirmeye yöneliktir. Enstitümüz kimlik, aidiyet ve yetkinlik ekseninde gençliğin karşı karşıya olduğu imkân ve riskleri bilimsel analizlerle ele alır; akademisyenler ve alanında uzman yöneticilerin katkılarıyla gençlik forumları, eğitim çalışmaları ve politika önerileri geliştirir. Yerli üretimi, girişimciliği ve sosyal sorumluluğu önceleyen bir gençlik anlayışının güçlenmesini hedefler.</p><p><strong>Tarih–Kültür–Medeniyet</strong> çalışmalarıyla, toplumsal hafızanın yeniden düşünülmesini ve gelecek tasavvuruna katkı sunmasını önemseriz. Arşiv çalışmaları, saha araştırmaları, akademik seminerler ve söyleşiler yoluyla; medeniyet birikimimizin bugünün meselelerine nasıl rehberlik edebileceğini ele alır, kültürel politikaların gelişimine katkı sunacak raporlar hazırlarız.</p><p><strong>Çevre–İklim–Tarım</strong> başlığında; doğayla uyumlu kalkınmayı, gıda güvenliğini ve su yönetimini merkeze alan yerli ve sürdürülebilir çözümler üzerinde dururuz. Akademisyenler, çiftçiler ve uzman yöneticilerin katılımıyla gerçekleştirilen çalıştaylar ve söyleşilerle, sahaya dayalı veriler üretmeyi ve uygulanabilir politika önerileri geliştirmeyi hedefleriz.</p><p><strong>Bilim-Teknoloji</strong> alanında ise savunma sanayiinden yapay zekâya, dijitalleşmeden uzay çalışmalarına kadar geniş bir perspektifle; milli ve yerli üretimi stratejik bir zorunluluk olarak ele alırız. Bilimsel yeniliği ahlak ve hikmetle birlikte düşünür; üniversiteler, sektör temsilcileri ve uzmanlarla düzenlenen çalıştay ve söyleşilerle, insan odaklı ve sürdürülebilir teknolojik dönüşüme katkı sunmayı amaçlarız.</p><p>Bu düşünce enstitüsü, yeni bir başlangıcın adıdır. Amacımız; ortak aklı büyüten, sahaya temas eden ve karar alıcılara yol gösteren bir düşünce zemini inşa etmektir.</p>",
      "backgroundImage": ""
    },
    "slug": "hakkimizda",
    "category": "kurumsal",
